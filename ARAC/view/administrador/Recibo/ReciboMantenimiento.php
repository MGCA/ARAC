...
<form action="?c=Recibo" method="post">
    ...
    <div class="well well-sm text-right">
        ...
        <a class="btn btn-primary" href="?c=Recibo&a=Generar">Crear Recibos</a>
    ...
    <table id="tabla" class="table table-striped">
        <thead>
            <tr>
                ...
                <th style="width:125px;">Pago</th>
                <th style="width:125px;">FechaVencimiento</th>
                <th style="width:125px;">N° Prevista</th>
                <th style="width:125px;">Estado</th>
                <th style="width:125px;">Cobro</th>
            </tr>
        </thead>
        <tbody>
